...
/**
  ...
  static buildSortedItems(actor, allItems) {
    ...
    const advantages = this._sortGeneric(actor, byType("advantage"), "advantages", this._advDisCols);
    
    const disadvantages = this._sortGeneric(actor, byType("disadvantage"), "disadvantages", this._advDisCols);
