...
export function preparePcExperience(actor, sys) {
  ...
  // Disadvantage cap: Maximum 10 XP from disadvantages per L5R4 rules
  ...
  const voidXP = voidBaseCur > voidBaseline
    ? calculateVoidXpCost(voidBaseline, voidBaseCur, voidDisc)
    : 0;
