...
/**
 * Official skill emphases from L5R4 rulebook organized alphabetically.
 * Provides list of recognized emphases that can be selected for skills.
 * Custom emphases can also be added by users at world or item level.
 *
 * Array format allows simple list display and filtering in emphasis manager.
 * Each skill can have multiple emphases based on rank (1/3/5/7/9 = 1/2/3/4/5 emphases).
 *
 * @constant {string[]}
 * @readonly
 */
