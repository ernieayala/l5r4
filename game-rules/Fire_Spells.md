...
All that a samurai requires to fulfill his duties is given to him by his lord, from the weapons he carries, to the armor that protects him, to the traveling pack that he carries as he moves throughout the Empire. Samurai are also given a stipend by their lord, however, and as such they have the money necessary to purchase additional items if they so desire. Any samurai purchasing additional weapons or armor must do so discreetly, however, since it is possible that some lords will take this as a statement that they have failed to equip their vassals properly. Most recognize that samurai are warriors, however, and are content to look the other way as their servants purchase additional weapons with which to enact their will.

## Armor

The design of armor varies considerably from Clan to Clan, and even varies from type to type within Clans. For the most part, however, Rokugani armor is comprised of lacquered plates of wood, ceramic, and metal. These suits are assembled with the intention of deflecting incoming weapon blows rather than attempting to stop them outright. Even the lowest quality katana can cut through wood without much difficulty, but purely metal armor is simply too cumbersome and restrictive to be worn for any length of time.
...
- **Bonus to Armor TN:** +5
- **Reduction:** 3
- **Special Rules:** Wearing light armor increases the TN of all Athletics and Stealth rolls by 5.
- **Price:** 25 koku
...
- **Reduction:** 5
- **Special Rules:** Wearing heavy armor increases the TN of all Skill Rolls using Agility or Reflexes by 5.
- **Price:** 40 koku
...
- **Bonus to Armor TN:** +4, +12 while on horseback
- **Reduction:** 4
- **Special Rules:** Riding armor is considered heavy armor for the purposes of mechanical effects that specify armor type, including Techniques, Advantages, etc. Wearing riding armor increases the TN of all Agility and Reflexes rolls by +5 unless the wearer is on horseback.
- **Price:** 55 koku

## Weapons

Weapons are in many ways the defining element of a samurai. In particular, the katana represents the soul of a samurai, and the wakizashi represents his honor. While the daisho, a matched pair of a katana and a wakizashi, is by far the most important and common weapon among samurai, there are a multitude of other options available, all of which have their advocates among the ranks of the Great Clans.
...
Weapons have a size: small, medium, or large. Although the categories have no drawbacks or benefits in and of themselves, they are a matter of consideration for other mechanical effects. Readying a large weapon takes longer than readying a small weapon, for example, and it is easier to conceal a small weapon, but of course large weapons tend to inflict more damage.

### Arrows

There are a variety of different arrows used by archers in Rokugan, all with a heavily specialized purpose, and all produced relatively inexpensively. The DR of an individual arrow is added to the Strength of the bow used to fire it to determine the total amount of dice used for the damage roll.

- **Armor Piercing:** These arrows replace the broader head of the Willow Leaf with a narrow spike intended to punch through armored plates. They are effective in penetrating armor, but sacrifice some of the damage inflicted.
- **Flesh Cutter:** These arrows have broader, sometimes barbed, heads intended to inflict tremendous damage on unarmored targets. They are almost useless against armored targets and cannot be fired as far as a standard Willow Leaf arrow, but against unarmored targets they are devastatingly effective.
- **Humming Bulb:** These arrows have a blunt, hollow tip that produces a loud whistling sound when fired. They are used for signaling or sounding alarms, and generally do little damage.
- **Rope Cutter:** Rope Cutters have broad, crescent shaped heads intended to cut rope or other similar items, such as banner strings and the like.
- **Willow Leaf (Ya):** The willow leaf or ya arrow is the standard arrow used by archers throughout the Empire. This is the arrow used to teach samurai archery beginning in their childhood, and the type used by the greatest archers in the land. Three quarters of all arrows carried by a typical archer are Willow Leaf arrows.

#### Table 3.1: Arrow Types

| Arrow Type     | DR  | Cost | Special Rules                                                     |
| -------------- | --- | ---- | ----------------------------------------------------------------- |
| Armor Piercing | 1k1 | 2 bu | Ignores the Armor TN bonus provided by armor                      |
| Flesh Cutter   | 2k3 | 5 bu | Double the Armor TN bonus provided by armor; ½ range              |
...
### The Economy of Rokugan

As discussed in the Book of Air, the basic unit of currency in Rokugan is the koku. One koku was originally intended to be the value assigned to the amount of rice necessary to feed one man for an entire year. A koku was broken down further into five bushels, represented by a small silver coin called a bu, and each bu was broken down into ten copper pennies called zeni.

Over the centuries, however, the development of Rokugan's economy has caused the monetary koku to become somewhat devalued. By the year 1170, for example, it would require approximately twelve koku to purchase rice sufficient to feed one man for a year. The prices of weapons and armor reflect this.

### Keywords

Some weapons have special qualities that affect how they are used, or introduce ramifications concerning their use. The most common keywords are:

- **PEASANT:** Weapons with this keyword are adapted from peasant tools or other implements. Using these weapons is usually considered the equivalent of using a Low Skill, and thus typically incurs a loss of Honor for each skirmish in which they are wielded against samurai opponents.
- **SAMURAI:** Weapons with this keyword are exclusively the province of the samurai caste. Anyone else in possession of one of these weapons is considered a criminal and subject to immediate execution.
- **SIZE:** Identifies whether a weapon is large, medium, or small.
...
Horses are an important possession for any samurai, although outside of the Unicorn Clan it is relatively uncommon for most samurai to possess one of their own unless they are particularly wealthy. Rules and abilities for horses are provided in the Book of Void.

In most cases, a samurai's lord will furnish a horse for him if it is required for the execution of his duties, which includes any significant travel. In the event that a character wishes to purchase a horse for himself, however, the following prices can be considered a starting point (all horses require roughly a koku of upkeep per month in terms of feeding, stabling, etc.):

- **Rokugani Pony:** 25 koku
- **Gaijin Riding Horse:** 75 koku
- **Utaku War Horse:** 250 koku (this is a minimum, and possession of one of these horses by an outsider is usually considered an affront to the honor of the Unicorn Clan, most likely resulting in duels)
...
Ranged weapons such as arrows bypass this barrier of fire, dealing Wounds as normal.
...
**Raises:** Area of Effect (+5 feet per two Raises)
...
**Raises:** Damage (+1k0 per two Raises), Duration (+2 Rounds)
...
You invoke the Fire kami to spring up and form a wall of flames, barring passage to all. The wall is 10' tall, 1' wide, and 25' long, and causes 6k6 Wounds to anyone who touches it. This wall may be made shorter or thinner as desired, within the total specifications, but all of the mass of flames must be used somehow. The wall may be created in an area where people or creatures are standing, forcing them to make a Reflexes Trait Roll against a TN of 20 to avoid taking Wounds from the fire.

You may Raise to increase one of the specifications (height, width, or length) by its base increment (10', 1', or 25' respectively).
...
**Raises:** Damage (+1k1 per two Raises)

A highly potent offensive spell, originally devised by the Isawa Elemental Masters, this prayer summons up a great mass of Fire kami, which roll outward from the caster in a wave of searing flames. Every target within the area of effect, whether friendly or hostile, takes 7k7 Wounds, for the raging flames make no distinction between ally and enemy. You alone do not take damage from the spell.
