...
The difficulty to domesticate and train an animal for use varies widely depending upon the animal in question. An assortment of animals can be found in the bestiary in the Book of Void, along with some guidelines on what they can do when trained.
...
*Sub-skills marked with an asterisk are considered Low Skills; sub-skills marked with # are considered High Skills
