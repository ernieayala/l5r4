...
In addition to their Rings, Traits, and Skills, characters have other ranked abilities that determine a great deal about their internal worth, how recognizable they are, and how important they are in the Emerald Empire. Those qualities are represented by Honor, Glory, and Status, respectively. These are attributes that affect the daily life of virtually every samurai. Like other character attributes, these three are normally ranked from 1 to 10, although it is possible, albeit unlikely, for some to have a 0 rank.
Each Rank of Honor, Glory, and Status is composed of ten Points, representing fractional changes in these rankings. When a character accumulates ten Points of Glory, for example, his Glory Rank increases by one and the ten Glory Points are lost. While Honor can be increased (or decreased) any time, Glory and Status require official recognition by a character's lord or superior in order to increase in Rank. For example, a soldier who gains enough Glory Points to increase his Glory Rank cannot do so until and unless his lord or commanding officer commends him for his actions and recognizes the acts that character committed to gain the Glory Points in question.
...
### HONOR RANKS 8-9: A SOUL ABOVE QUESTION
...
- The Emperor: 10
- The Empress: 9.9
- The Voice of the Emperor: 9.5
- The Emperor's Children: 9.4
- Daimyo of the Miya, Otomo, & Seppun: 9.3
- Emerald Champion, Jade Champion, Shogun: 9
- Imperial Chancellor, Imperial Advisor: 9
- Great Clan Champion: 8
- Minor Clan Champion: 7.5
- The Imperial Herald: 7
- The Imperial Treasurer: 7
- Peasant soldiers, peasant warriors: 0.5
- Village officers, vassal samurai: 0.5

Status grants a samurai authority over other samurai of lower Status, but only if those samurai exist within the same hierarchy. A Lion samurai with Status 3, for instance, still cannot issue commands to a Mantis samurai with Status 2 unless the two of them are members of the same military organization or a comparable social order of some sort; otherwise the Lion simply has no authority over the Mantis. On the other hand, a Lion of Status 3 can usually issue orders to another Lion of Status 2. Samurai must always be careful in doing so, however, and make sure they do not interrupt or countermand the orders of a different samurai with an even greater Status than their own.
